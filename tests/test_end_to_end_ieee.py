...
def test_end_to_end_ieee():
    ...
    input_docx = r"d:\221761_TIEN_PHONG_TT_VL_2026\input_data\Template_word\Vietnamese Text-to-Speech System Using Artificial Intelligence (AI).docm"
    template_docx = r"d:\221761_TIEN_PHONG_TT_VL_2026\input_data\Template_word\conference-template-a4 (ieee).docx"
    output_docx = r"d:\221761_TIEN_PHONG_TT_VL_2026\outputs\FINAL_IEEE_OUTPUT.docx"
    workspace = r"d:\221761_TIEN_PHONG_TT_VL_2026\outputs\tmp_workspace"
