...
## Cap Nhat Gan Day (2026-04)

- Bo sung **Admin Dashboard**: quan ly user, premium, token, lich su theo tung tai khoan.
- Bo sung **Google Sign-In** (id_token verify audience) song song auth local.
- Bo sung **Trang Premium** cho nguoi dung tu dang ky goi premium bang token.
- Bo sung **CLI one-shot** cho dev: chay chuyen doi tren terminal, khong can UI keo-tha.
...
|---|---|---|
| **Python** | 3.10+ | Bắt buộc cho backend/core engine |
