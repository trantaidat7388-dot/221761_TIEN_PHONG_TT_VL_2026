...
*   **Cách 1: Cài trên máy** (sinh PDF ngay lập tức)
    *   **Windows**: [MiKTeX](https://miktex.org/download) (nhẹ, tự tải gói) hoặc [TeX Live](https://tug.org/texlive/)
    *   **macOS**: [MacTeX](https://www.tug.org/mactex/)
    *   **Linux**: `sudo apt install texlive-full`
    *   Đảm bảo lệnh `xelatex` chạy được từ Terminal/CMD.
...
Tạo file `.env` cho backend và frontend từ mẫu:
...
Sau đó mở file `backend/.env` và chỉnh sửa các giá trị cần thiết (xem mục [Cấu Hình Biến Môi Trường](#cấu-hình-biến-môi-trường)).
